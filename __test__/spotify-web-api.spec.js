      ...
      describe('Using callbacks',
               function() {
                 it('should get a track', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.track))
                       .toBeTruthy();
                 ...
                 it('should get multiple tracks', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.tracks))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get an album', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.album))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get multiple albums', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.albums))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get an artist', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.artist))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get 2 artist\'s albums', function() {
                   ...
                   expect(callback.calledWith(null,
                                              fixtures.artist_albums_limit_2))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get an artist\'s top tracks', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.getArtistTopTracks('5YyScSZOuBHpoFhGvHFedc', 'ES',
                                          callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                 ...
                 it('should get an artist\'s related artists', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.getArtistRelatedArtists('6J6yx1t3nwIDyPXk5xa7O8',
                                               callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                       JSON.stringify(fixtures.artist_related_artists));
                   expect(callback.calledWith(null,
                                              fixtures.artist_related_artists))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get multiple artists', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.artists))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should search for several types', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.search('muse', [ 'track', 'artist' ], {limit : 1},
                              callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                       JSON.stringify(fixtures.search));
                   expect(callback.calledWith(null, fixtures.search))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should search for playlists', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.searchPlaylists('music', {offset : 0, limit : 5},
                                       callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                 ...
                 it('should get information about a user', function() {
                   ...
                   expect(callback.calledWith(null, fixtures.user))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                 ...
                 it('should get information about the current logged in user',
                    function() {
                      ...
                      expect(callback.calledWith(null, fixtures.me))
                          .toBeTruthy();
                      expect(that.requests.length).toBe(1);
                      expect(that.requests[0].url)
                 ...
                 it('should get user\'s recently played tracks', function() {
                   ...
                   expect(callback.calledWith(null,
                                              fixtures.recently_played_tracks))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should create a playlist', function() {
                   ...
                   api.setAccessToken('<example_access_token>');
                   api.createPlaylist(
                       'a_user', {name : 'A name for the playlist'}, callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                 ...
                 it('should remove tracks from a playlist specifying just their positions and snapshot id',
                    function() {
                      ...
                      api.removeTracksFromPlaylistInPositions(
                          '7Kud0O2IdWLbEGgvBkW9di', [ 0, 1, 3, 9 ],
                          'AsNaPsHoTiD', callback);
                      that.requests[0].respond(
                          200, {'Content-Type' : 'application/json'}, '');
                      expect(callback.calledWith(null, '')).toBeTruthy();
                 ...
                 it('should reorder tracks in a playlist with optional parameters',
                    function() {
                      ...
                      var api = new SpotifyWebApi();
                      api.setAccessToken('<example_access_token>');
                      api.reorderTracksInPlaylist('7Kud0O2IdWLbEGgvBkW9di', 1,
                                                  3, {range_length : 2},
                                                  callback);
                      that.requests[0].respond(
                          200, {'Content-Type' : 'application/json'},
                 ...
                 it('should upload a custom playlist cover image', function() {
                   ...
                   var imageDataWithoutEncoding =
                       '/9j/4AAQSkZJRgABAQAAAQABAAD/2';
                   api.setAccessToken('<example_access_token>');
                   api.uploadCustomPlaylistCoverImage('7Kud0O2IdWLbEGgvBkW9di',
                   ...
                   expect(
                       that.requests[0].requestHeaders['Content-Type'].includes(
                           'image/jpeg'))
                       .toBe(true);
                 ...
                 it('should get list of categories', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.getCategories({locale : 'sv_SE', country : 'SE'},
                                     callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                 ...
                 it('should get the dinner category playlists', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.getCategoryPlaylists('dinner', {country : 'SE'},
                                            callback);
                   that.requests[0].respond(
                       200, {'Content-Type' : 'application/json'},
                 ...
                 it('should check whether a user is following several other users',
                    function() {
                      var callback = sinon.spy();
                      var api = new SpotifyWebApi();
                      api.isFollowingUsers([ 'userid01', 'userid02' ],
                                           callback);
                      that.requests[0].respond(
                          200, {'Content-Type' : 'application/json'},
                 ...
                 it('should unfollow several artists', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.unfollowArtists([ 'artistid01', 'artistid02' ],
                                       callback);
                   that.requests[0].respond(204);
                   expect(that.requests[0].method).toBe('DELETE');
                   expect(callback.calledWith(null, '')).toBeTruthy();
                 ...
                 it('should follow a playlist privately', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.followPlaylist('2ujjMpFriZ2nayLmrD1Jgl',
                                      {public : false}, callback);
                   that.requests[0].respond(200);
                   expect(that.requests[0].method).toBe('PUT');
                   expect(callback.calledWith(null, '')).toBeTruthy();
                   expect(that.requests.length).toBe(1);
                 ...
                 it('should check whether users are following a playlist',
                    function() {
                      ...
                      that.requests[0].respond(
                          200, {'Content-Type' : 'application/json'},
                          JSON.stringify(
                              fixtures.follow_are_following_playlist));
                 ...
                 it('should get the audio features for several tracks', function() {
                   ...
                   expect(that.requests[0].method).toBe('GET');
                   expect(callback.calledWith(null,
                                              fixtures.tracks_audio_features))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should get current playing track', function() {
                   ...
                   expect(that.requests[0].method).toBe('GET');
                   expect(callback.calledWith(null,
                                              fixtures.current_playing_track))
                       .toBeTruthy();
                   expect(that.requests.length).toBe(1);
                   expect(that.requests[0].url)
                       .toBe(
                 ...
                 it('should set repeat', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.setRepeat('track', {device_id : 'my_device_id'},
                                 callback);
                   that.requests[0].respond(204);
                   expect(that.requests[0].method).toBe('PUT');
                   expect(callback.calledWith(null, '')).toBeTruthy();
                 ...
                 it('should unset shuffle', function() {
                   var callback = sinon.spy();
                   var api = new SpotifyWebApi();
                   api.setShuffle(false, {device_id : 'my_device_id'},
                                  callback);
                   that.requests[0].respond(204);
                   expect(that.requests[0].method).toBe('PUT');
                   expect(callback.calledWith(null, '')).toBeTruthy();
